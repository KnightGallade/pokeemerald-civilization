...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    // TODO - added FRLG classes here
    [TRAINER_CLASS_FRLG_EARLY_RIVAL] = { _("RIVAL"), 4, BALL_POKE },
    [TRAINER_CLASS_FRLG_LATE_RIVAL] = { _("RIVAL"), 9, BALL_ULTRA },
    [TRAINER_CLASS_FRLG_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_ULTRA },
    [TRAINER_CLASS_FRLG_COOLTRAINER] = { _("COOLTRAINER"), 12, BALL_ULTRA },
    [TRAINER_CLASS_FRLG_TAMER] = { _("TAMER"), 10, BALL_ULTRA },
    [TRAINER_CLASS_FRLG_BUG_CATCHER] = { _("BUG CATCHER"), 4, BALL_NET },
    [TRAINER_CLASS_FRLG_LEADER] = { _("LEADER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_FRLG_CAMPER] = { _("CAMPER"), 4, BALL_POKE },
    [TRAINER_CLASS_FRLG_YOUNGSTER] = { _("YOUNGSTER"), 4, BALL_POKE },
    [TRAINER_CLASS_FRLG_LASS] = { _("LASS"), 4, BALL_POKE },
...
u32 GetBattlerTotalSpeedStatArgs(u32 battler, u32 ability, u32 holdEffect)
{
    ...
    if (!(gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK | BATTLE_TYPE_FRONTIER))
        && ShouldGetStatBadgeBoost(FLAG_HOENN_BADGE03_GET, battler)
