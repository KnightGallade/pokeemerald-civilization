...
static const u8 sMapHealLocations[][3] =
{
    ...
    // Adding the Kanto map fly zones
    ...
    [MAPSEC_ROUTE_4] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), HEAL_LOCATION_ROUTE_4},
    [MAPSEC_ROUTE_10] = {MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10), HEAL_LOCATION_ROUTE_10},
    [MAPSEC_ROUTE_1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), HEAL_LOCATION_NONE},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_INDIGO_PLATEAU:
        return FlagGet(FLAG_VISITED_INDIGO_PLATEAU_EXTERIOR) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SAFFRON_CITY:
        return FlagGet(FLAG_VISITED_SAFFRON_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_4:
        return FlagGet(FLAG_VISITED_ROUTE4_POKEMON_CENTER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_10:
        return FlagGet(FLAG_VISITED_ROUTE10_POKEMON_CENTER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
